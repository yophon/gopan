...
当前阶段:**M1~M5 完成,待真机上线打 v1.0.0**(部署走 doc/09 上线手册;分全家桶 / 精简两档,2G 小机可关 Gotenberg 与自带反代)。功能:分片直传/秒传/断点续传、图片/音视频/PDF/文本/Office 预览、文件与文件夹分享(密码、有效期、访客只读子树)、打包下载、回收站、双 token 认证。
