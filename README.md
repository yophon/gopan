...
当前阶段:**v1.1.0——v1 已上线(2026-07-12,踩坑复盘见 doc/10),v2 推进中**(M7 管理端已交付,规划见 doc/13)。部署走 doc/09 上线手册,分全家桶 / 精简两档,2G 小机可关 Gotenberg 与自带反代。功能:分片直传/秒传/断点续传、图片/音视频/PDF/文本/Office 预览、文件与文件夹分享(密码、有效期、访客只读子树)、打包下载、回收站、双 token 认证、管理端。
